...
<body>
    ...
    <div class="table-foot" >
		 ...
		 <span>总记录数：${userRolePageInfo.total}</span>
	</div>
    ...
    <script>
	    ...
	    page.init({
	        target: $('#pageToolbar'),
	        count: ${userRolePageInfo.total}, //总记录数
	        pagesize: ${userRolePageInfo.pageSize}, //每页的条数
	        current: ${userRolePageInfo.pageNum}, //当前页码，默认为1
	        toolbar: true,
	        hash: true,
	        pageSizeList: [1, 2, 3, 5, 10, 15],
	        callback: function(pageNum, pageSize, totals) {
	        	window.location.href  = "${basePath}/userpermission/usertb?flag=1&pageNum="+pageNum+"&pageSize="+pageSize;
	        },
