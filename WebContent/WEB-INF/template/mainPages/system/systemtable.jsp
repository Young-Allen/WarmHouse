...
<body>
   	<div class="user-tablelist" >
   		<iframe id="usertablelist" name="userTableList" src="systemtableList" width="100%" height="100%" frameborder="0"  scrolling="yes"></iframe>
   	</div>
   	
    <div class="table-foot" >
		 <div id="pageToolbar" style="display: inline-block;"></div>
		 <span>总记录数：${systemTablePageInfo.total}</span>
	</div>
    ...
    <script>
	    ...
	    page.init({
	        target: $('#pageToolbar'),
	        count: ${systemTablePageInfo.total}, //总记录数
	        pagesize: ${systemTablePageInfo.pageSize}, //每页的条数
	        current: ${systemTablePageInfo.pageNum}, //当前页码，默认为1
	        toolbar: true,
	        hash: true,
	        pageSizeList: [1, 2, 3, 5, 10, 15],
	        callback: function(pageNum, pageSize, totals) {
	        	window.location.href  = "${basePath}/systable/systb?flag=1&pageNum="+pageNum+"&pageSize="+pageSize;
	        },
